...
export class WarServer {
    ...
    private _gameServer = new GameServer(this._configManager, this._cryptManager, this._log.createChildContext("Game Server"));
    private _expressServer = new ExpressServer(this._configManager, this._cryptManager, this._gameServer, this._log.createChildContext("Express Server"));
    private _socketServer = new SocketServer(this._configManager, this._cryptManager, this._gameServer, this._log.createChildContext("Socket Server"));
