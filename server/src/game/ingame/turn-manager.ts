import type { GameConfig, RoundState, TurnAction, TurnAllowedAction, TurnPhase } from ':protocol';
import type { Logger } from '../../log/logger';
import { ServerPacketGameError } from '../../socket/packet/game/game-error';
import { ServerPacketTurnAllowedActions } from '../../socket/packet/game/turn-allowed-actions';
import { ServerPacketUpdateRoundState } from '../../socket/packet/game/update-round-state';
