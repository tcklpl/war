...
import BlackBlockIcon from ':icons/anarchism/black-block-icon';
import FearsomeEnemyIcon from ':icons/anarchism/fearsome-enemy-icon';
import FrenzyIcon from ':icons/anarchism/frenzy-icon';
import OffensiveManiacIcon from ':icons/anarchism/offensive-maniac-icon';
import PowerVoidIcon from ':icons/anarchism/power-void-icon';
import SpontaneousSpawnIcon from ':icons/anarchism/spontaneous-spawn-icon';
