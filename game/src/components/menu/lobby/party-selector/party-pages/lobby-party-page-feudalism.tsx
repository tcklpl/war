...
import DragonIcon from ':icons/feudalism/dragon-icon';
import { Box, Table, TableBody, TableCell, TableRow, Typography } from '@mui/material';
import { useTranslation } from 'react-i18next';
import { TSXUtils } from '../../../../../utils/tsx-utils';
import LobbyAdminConfigTitle from '../../admin/config-pages/components/lobby-admin-cfg-title';
		...
		<Box width='100%' height='100%' display='flex' flexDirection='column'>
			<Table width='100%'>
				<TableBody>
					...
					<TableRow>
						<TableCell>
							<Typography color='primary'>{t('parties:feudalism_pa_defense')}</Typography>
						</TableCell>
						<TableCell>
							<Typography>{t('parties:feudalism_pa_defense_desc')}</Typography>
						</TableCell>
					</TableRow>
					...
					<TableRow>
						<TableCell>
							<Typography color='primary'>{t('parties:feudalism_bn_troop_gain')}</Typography>
						</TableCell>
						<TableCell>
							<Typography>
								{TSXUtils.replaceWithElement(t('parties:feudalism_bn_troop_gain_desc'), {
									toReplace: '<TROOPS>',
									value: k => (
										<Typography color='secondary' display='inline' component='span' key={k}>
											{cfg.bonus.troop_bonus_on_conquering}
										</Typography>
									),
								})}
							</Typography>
					...
					<TableRow>
						<TableCell>
							<Typography color='primary'>{t('parties:feudalism_db_one_attack')}</Typography>
						</TableCell>
						<TableCell>
					...
					<Table width='100%'>
						<TableBody>
								...
								<TableCell colSpan={2}>
									...
									<Typography variant='body1'>
										{TSXUtils.replaceWithElement(
											t('parties:feudalism_su_dragon_desc'),
											{
												toReplace: '<HP>',
												value: k => (
													<Typography component='span' color='secondary' key={k}>
														{cfg.special_units.dragon.hp}
													</Typography>
												),
											},
											{
												...
												value: k => (
													<Typography component='span' color='secondary' key={k}>
														{cfg.special_units.dragon.hp_increase_rate_until_max_hp}
													</Typography>
												),
											},
											{
												...
												value: k => (
													<Typography component='span' color='secondary' key={k}>
														{cfg.special_units.dragon.max_hp}
													</Typography>
												),
											},
											{
												...
												value: k => (
													<Typography component='span' color='secondary' key={k}>
														{cfg.special_units.dragon.hp_recovery_on_walled_territory}
													</Typography>
												),
											},
										)}
							...
							<TableRow>
								...
								<TableCell>
									<Typography color='secondary'>{cfg.special_units.dragon.hp}</Typography>
								</TableCell>
							</TableRow>
							<TableRow>
								<TableCell>
								...
								<TableCell>
									<Typography color='secondary'>{cfg.special_units.dragon.max_hp}</Typography>
								</TableCell>
							</TableRow>
							<TableRow>
								<TableCell>
								...
								<TableCell>
									<Typography>
										{TSXUtils.replaceWithElement(t('parties:feudalism_su_dragon_spawn'), {
											...
											value: k => (
												<Typography component='span' color='secondary' key={k}>
													{cfg.special_units.dragon.cooldown_after_dying}
												</Typography>
											),
										})}
									</Typography>
							...
							<TableRow>
								...
								<TableCell>
									<Typography>{t('countries:france')}</Typography>
								</TableCell>
							</TableRow>
						</TableBody>
					</Table>
