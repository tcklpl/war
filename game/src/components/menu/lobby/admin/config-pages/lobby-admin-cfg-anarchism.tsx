			...
			<Table width='100%'>
				<TableBody>
					...
					<LobbyAdminConfigTitle
						title={`${t('lobby:special_units')} - ${t('lobby:cfg_anarchism_su_black_block')}`}
					/>
					<LobbyAdminConfigGroupHp
						hp={cfg.special_units.black_block.hp}
						maxHp={cfg.special_units.black_block.max_hp}
						setHp={hp => {
					...
					<LobbyAdminConfigOption
						options={{
							...
							description: t(
								'lobby:cfg_anarchism_su_black_block_number_of_lost_territories_required_to_spawn_desc',
							),
