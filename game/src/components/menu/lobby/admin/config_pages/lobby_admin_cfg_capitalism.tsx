...
const LobbyAdminConfigScreenCapitalism = ({ disabled }: { disabled: boolean }) => {
    ...
    const [cfg, setCfg] = useState(currentLobbyState?.game_config.party_config.capitalism);
    useEffect(() => {
        if (!cfg) return;
        modifyLobbyState(s => {
        ...
        <Box width="100%" height="100%">
            <Table width="100%">
                <TableBody>
                    ...
                    <LobbyAdminConfigGroupHp hp={cfg.special_units.john_keynes.hp} maxHp={cfg.special_units.john_keynes.max_hp}
                        setHp={(hp) => {
                    ...
                    <LobbyAdminConfigGroupHp hp={cfg.special_units.ray_croc.hp} maxHp={cfg.special_units.ray_croc.max_hp}
                        setHp={(hp) => {
                    ...
                    <LobbyAdminConfigGroupHp hp={cfg.special_units.mark_zuckerberg.hp} maxHp={cfg.special_units.mark_zuckerberg.max_hp}
                        setHp={(hp) => {
                    ...
                    <LobbyAdminConfigGroupHp hp={cfg.special_units.steve_jobs.hp} maxHp={cfg.special_units.steve_jobs.max_hp}
                        setHp={(hp) => {
                    ...
                    <LobbyAdminConfigGroupHp hp={cfg.special_units.donald_trump.hp} maxHp={cfg.special_units.donald_trump.max_hp}
                        setHp={(hp) => {
