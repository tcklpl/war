...
import CfgScreenDefaultBackground from '../default-background/cfg-default-background';
import CfgDisplayScreen from '../display/cfg-display-screen';
import CfgGameScreen from '../game/cfg-game-screen';
import CfgGraphicsScreen from '../graphics/cfg-graphics-screen';
import style from './cfg-screen.module.scss';
