        ...
        <Grid container className="pause-screen">
            ...
            >
                ...
                <Stack spacing={1}>
                    ...
                    <Button color="primary" onClick={() => { setOpen(false) }} fullWidth={true} style={{justifyContent: "flex-start"}} startIcon={<KeyboardBackspaceIcon/>}>Resume</Button>
                    <Button color="primary" onClick={() => { setCurrentRightScreen(<CfgScreen/>) }} fullWidth={true} style={{justifyContent: "flex-start"}} startIcon={<SettingsIcon/>}>Settings</Button>
