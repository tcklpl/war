...
import type { GLTFAnimation } from './gltf-animation';
import type { GLTFCamera } from './gltf-camera';
import type { GLTFLight } from './gltf-light';
import type { GLTFMesh } from './gltf-mesh';
