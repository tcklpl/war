...
import { RenderStageOutlineMask } from './render-stages/geometry/outline-mask.render-stage';
...
import { RenderStageSSAO } from './render-stages/post/ssao.render-stage';
