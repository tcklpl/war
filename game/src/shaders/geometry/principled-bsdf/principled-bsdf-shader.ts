...
import fragStructs from './frag-structs.wgsl?raw';
import fragmentShader from './fragment.wgsl?raw';
import lightDirectional from './light/directional.wgsl?raw';
import lightEval from './light/light-eval.wgsl?raw';
import lightPunctual from './light/punctual.wgsl?raw';
import lightShadowFiltering from './light/shadow-filtering.wgsl?raw';
...
import precomputedKernels from './precomputed-kernels.wgsl?raw';
